...
type ScanTableResults struct {
	SecurityVulnerabilitiesTable           []vulnerabilityScanTableRow
	LicensesTable 				 []licenseScanTableRow
	LicenseViolationsTable 	   []licenseViolationScanTableRow
	SecretsTable 			   []secretsTableRow
	Errors 						[]error
}
