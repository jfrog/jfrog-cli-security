		...
		return func(threadId int) (err error) {
			...
			taskFunc := func(threadId int) (err error) {
				...
				if entitledForJas && scanCmd.commandSupportsJAS {
					...
					scanner, err = jas.CreateJasScanner(scanner, jfrogAppsConfig, scanCmd.serverDetails, jas.GetAnalyzerManagerXscEnvVars("", validateSecrets, techutils.Technology(graphScanResults.ScannedPackageType)))
					if err != nil {
