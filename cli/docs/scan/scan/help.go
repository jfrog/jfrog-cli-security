...
func GetArguments() []components.Argument {
	return []components.Argument{{Name: "source pattern", ReplaceWithFlag: flags.SpecFlag, Description: `Specifies the local file system path of the files to be scanned.
