...
func RunXrayDependenciesTreeScanGraph(dependencyTree xrayUtils.GraphNode, technology coreutils.Technology, scanGraphParams *scangraph.ScanGraphParams) (results []services.ScanResponse, err error) {
