...
require (
	...
	github.com/jfrog/jfrog-cli-core/v2 v2.56.6
...
replace github.com/jfrog/build-info-go => github.com/eranturgeman/build-info-go v0.0.0-20241110090509-477ca696b49b
