...
var flagsMap = map[string]components.Flag{
	...
	Npm:          components.NewBoolFlag(Npm, "Set to true to request audit for a npm project (supports workspaces)."),
	Pnpm:         components.NewBoolFlag(Pnpm, "Set to true to request audit for a Pnpm project."),
	Yarn:         components.NewBoolFlag(Yarn, "Set to true to request audit for a Yarn project (supports workspaces)."),
