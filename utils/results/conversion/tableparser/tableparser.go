...
func (tc *CmdResultsTableConverter) Get() (formats.ResultsTables, error) {
	...
	return formats.ResultsTables{
		...
		MaliciousVulnerabilitiesTable:  formats.ConvertToIacOrSastTableRow(simpleJsonFormat.MaliciousVulnerabilities),
		MaliciousViolationsTable:       formats.ConvertToIacOrSastTableRow(simpleJsonFormat.MaliciousViolations),
	}, nil
}
