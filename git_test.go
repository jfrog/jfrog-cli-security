...
func TestGitAuditJasSkipNotApplicableCvesViolations(t *testing.T) {
	...
	createTestProjectRunGitAuditAndValidate(t, projectPath,
		...
		validations.ValidationParams{
			Violations: &validations.ViolationCount{
				ValidateScan:                &validations.ScanCount{Sca: 69, Sast: 5, Secrets: 6, Services: 6},
				ValidateApplicabilityStatus: &validations.ApplicabilityStatusCount{NotApplicable: 61, NotCovered: 7, MissingContext: 1, Inactive: 1},
			},
	...
	createTestProjectRunGitAuditAndValidate(t, projectPath,
		...
		validations.ValidationParams{
			Violations: &validations.ViolationCount{
				ValidateScan:                &validations.ScanCount{Sca: 8, Sast: 5, Secrets: 6, Services: 6},
				ValidateApplicabilityStatus: &validations.ApplicabilityStatusCount{NotCovered: 7, MissingContext: 1, Inactive: 1},
			},
			ExactResultsMatch: true,
		},
	)
