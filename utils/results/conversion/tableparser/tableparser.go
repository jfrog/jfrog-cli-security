...
func (tc *CmdResultsTableConverter) Get() (formats.ResultsTables, error) {
	...
	return formats.ResultsTables{
		...
		ServicesVulnerabilitiesTable:   formats.ConvertToServicesTableRow(simpleJsonFormat.ServicesVulnerabilities),
		ServicesViolationsTable:        formats.ConvertToServicesTableRow(simpleJsonFormat.ServicesViolations),
